                            ...
                            {ordersLoading ? (
                                ...
                                <div className="space-y-6">
                                    {myOrders.map(order => {
                                        ...
                                        return (
                                            <div key={order.id} className="bg-card border rounded-3xl p-6 shadow-sm">
                                                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                                                    <div className="flex items-center gap-3">
                                                        <div className="bg-accent/10 p-3 rounded-xl"><Package size={24} className="text-accent" /></div>
                                                        <div>
                                                            <p className="font-bold text-lg">{order.product?.name || 'Unknown Product'}</p>
                                                            <p className="text-sm text-muted-foreground font-mono">{order.short_id} • {order.duration_count} {order.duration_type === 'monthly' ? 'Months' : 'Weeks'}</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-secondary/20 p-4 rounded-2xl mb-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="font-black">₹{pending.toLocaleString('en-IN')}</p>
                                                    </div>
                                                    <div>
