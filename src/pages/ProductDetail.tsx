...
import { ShieldCheck, MapPin, Calculator, Store, Zap, CreditCard } from 'lucide-react';
    ...
    return (
        ...
        >
            <div className="flex flex-col lg:flex-row gap-12 xl:gap-20">
                ...
                >
                    <div className="bg-card border border-border/50 rounded-[2.5rem] p-12 flex items-center justify-center aspect-square shadow-sm relative overflow-hidden group">
                ...
                <div className="lg:w-1/2 flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <motion.h1
                            ...
                            className="text-4xl lg:text-5xl font-black tracking-tight leading-[1.1]"
                        >
                            {product.name}
                        </motion.h1>
                    ...
                    <motion.div
                        ...
                        className="flex flex-col gap-2 p-6 rounded-[2rem] bg-gradient-to-br from-card to-secondary/20 border border-border/60 shadow-sm"
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {emiPlans.map((plan: any, idx: number) => (
                                <motion.div
                                    ...
                                    className={`relative p-5 rounded-2xl cursor-pointer transition-all duration-300 border-2 ${selectedPlan === idx
